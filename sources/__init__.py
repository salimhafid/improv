...
from . import annoyance, brooklyn_cc, io_chicago, logan_square, magnet, playground, second_city, ucb, ucb_classes, wgis
...
SOURCES = [
    ...
    {"id": "logan_square", "org": "Logan Square Improv", "city": "Chicago", "fetch": logan_square.fetch},
    {"id": "playground", "org": "The Playground Theater", "city": "Chicago", "fetch": playground.fetch},
]
